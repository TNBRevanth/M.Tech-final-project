...
& $python aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a25bicidozi3pr-ats.iot.ap-south-1.amazonaws.com --ca_file root-CA.crt --cert ppgthing.cert.pem --key ppgthing.private.key --client_id basicPubSub --topic sdk/test/python --count 0